...
export const changelogData: ChangelogVersion[] = [
  {
   ...
   summary: "Solo-designing and engineering a creative writing tool built on a relational annotation graph — every product surface (editor, wiki, clothesline, investigation boards) is a query projection over the same underlying data. Full-stack: Next.js, ProseMirror, Neon Postgres, Drizzle ORM, offline-first with IndexedDB replay.",
   isCurrent: true,
   color: "green",
   entries: [
