...
<JsonLd data={{
  ...
  "@type": "TechArticle",
  "headline": "Java Game Development Tutorial",
  "datePublished": "2022-01-15",
  "author": { "@type": "Person", "name": "Taylor McNeil" },
  "url": "https://www.taylormcneil.dev/tutorials/java-game-dev"
}} />
...
<AnchorSidebar
  items={[
    ...
    { id: "1-separation-of-concerns", label: "Separation of Concerns", level: 3 },
    { id: "2-input-robustness", label: "Input Robustness", level: 3 },
    { id: "3-algorithmic-efficiency", label: "Algorithmic Efficiency", level: 3 },
    { id: "what-this-teaches", label: "What This Teaches", level: 3 },
  ]}
/>
...
<TutorialHeader
  ...
  method="GET"
  endpoint="/tutorials/java-game-dev"
  readTime="11 min read"
  views="75K+ views"
  date="May 6, 2021"
  source={{ name: "View on Medium", url: "https://medium.com/codex/tic-tac-toe-e53212028341" }}
  mdxPath="src/app/tutorials/java-game-dev/page.mdx"
/>

<Callout type="context" title="Editor's Note 2025">
This tutorial was originally written when I was first learning Java. 
I've kept the original code below as a time capsule of my learning journey. 
If you want to see how I would write this today, with proper input validation 
and error handling, check out the interactive demo and retrospective at the bottom.
</Callout>
...
- **Java JDK 11 or higher** — This tutorial uses basic Java features that work with any modern version. [Download from Oracle](https://www.oracle.com/java/technologies/downloads/) or use OpenJDK.
- **A text editor or IDE** — Any editor works, but [VS Code](https://code.visualstudio.com/) with the Java Extension Pack or [IntelliJ IDEA Community Edition](https://www.jetbrains.com/idea/download/) will give you syntax highlighting and error checking.
