...
This is the design companion to <a href="/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1">March Marketing Dev log<ExternalLink size={12} className="inline" /></a>.
</Callout>
...
Rather than explain what I mean, let me give you the keys.
...
Next month, we oil wrestle Proteus.

<DevlogCTA
  linkText="Read: March Marketing Devlog"
  linkHref="/"
>
