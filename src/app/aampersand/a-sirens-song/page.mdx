...
<JsonLd data={{
  ...
  "@type": "Article",
  "headline": "A Siren's Song",
  "description": "Why VS Code's multi-pane interface is wrong for writers, and how a failed first design led to a two-pane architecture for complex fiction.",
